...
function SearchBar({recipes, setRecipes}){
    ...
    return (
        ...
        <div className="flex justify-center items-center m-8">
            <input type="text" placeholder="Search for recipes" className="border border-gray-300 p-2 rounded-lg w-1/2" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
            <button onClick={searchRecipes} className="bg-blue-500 text-white p-2 rounded-lg ml-2">
